        ...
        <div id='profile' className="profile">
            <div className='container'>
                ...
                <div className='profile__title'>
                    <span data-aos="fade-up" data-aos-duration="1100" style={{ letterSpacing: '0.14em', textTransform: 'uppercase' }}>Based in France / Available worldwide</span>
                ...
                <a href="#contact" data-aos="fade-up" data-aos-delay="150" className='profile__cta'>Start a conversation <span aria-hidden="true">↗</span></a>
                <Services />
            </div>
        </div>
    )

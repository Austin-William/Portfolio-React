const projects = [
    {
        ...
        screenshots: [
            ...
            "assets/projects/paperwork/9.png",
            "assets/projects/paperwork/10.png",
            "assets/projects/paperwork/11.png",
            "assets/projects/paperwork/12.png",
            "assets/projects/paperwork/13.png",
            "assets/projects/paperwork/14.png",
            "assets/projects/paperwork/15.png",
            "assets/projects/paperwork/16.png",
            "assets/projects/paperwork/17.png",
            "assets/projects/paperwork/18.png",
            "assets/projects/paperwork/19.png",
            "assets/projects/paperwork/20.png",
        ],
        technologies: [
            "ReactJS",
            "Typescript",
    ...
    },
    {
        id: 2,
        name: "Area",
        description: "A web app to manage your different account in one app thanks to the API of the different services (Discord, Twitter, ...). This project is the latest and biggest project during my 3rd years at Epitech. We had to develop a full-stack app with a team of 6 people in 2 months at the same time of other projects. It regroups all the knowledge that we learned during the year.",
        url: "",
    ...
    },
    {
        id: 3,
        name: "Dashboard",
        description: "A web app to display 6 different widgets (weather, Twitter, Reddit, Youtube, Github and Unsplash API). The goal of this project was to learn how to use APIs and to develop a full-stack app.",
        url: "",
    ...
    },
    {
        id: 4,
        name: "Redditech",
        description: "A mobile application using Reddit API. My first mobile app using an API.",
        url: "",
    ...
    },
    {
        id: 6,
        name: "Check The Time",
        description: "A website to check the time in different timezones.",
    ...
    },
    {
        ...
        description: "Inspired from a video, this project is a portfolio made with NextJS to learn this framework.",
...
const experiences = [
    ...
    },
    {
        ...
        missions: [
            ...
            "Develop features of the back-office with Next.JS to manage the users and the paperworks",
    ...
    },
    {
        ...
        missions: [
            ...
            "Cost estimation of the new features",
            "Rework the website to improve the performance and the design from Figma mockups",
            "Report the bugs and fix them in production",
            "Demonstrate all new/modified features to the client",
            "Implement Google reCaptcha V2",
            "Implement tracking tools to monitor the website's performance and the user's behavior with Google Analytics and Google Tag Manager",
            "Create the documentation to maintain and to develop the website for developers",
            "Writing conception documents for the new features to check if the feature is possible to develop and to estimate the cost",

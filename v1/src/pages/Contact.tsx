                ...
                <div className='right' data-aos="fade-up" data-aos-duration="1000">
                    <form className='contact__form' ref={form} onSubmit={sendEmail}>
                        <div className='contact__input' data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <input className='animation a3' type="email" name="email" id="email" placeholder="Email Address" autoComplete="email" onChange={(e: ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)} />
                        </div>
                        <div className='contact__input' data-aos="fade-up" data-aos-duration="1500">
                            <label className='animation a4' htmlFor="name">Name</label>
                            <input className='animation a5' type='text' name="name" id="name" placeholder="Name" autoComplete="name" onChange={(e: ChangeEvent<HTMLInputElement>) => setName(e.target.value)} />
                        </div>
                        <div className='contact__input' data-aos="fade-up" data-aos-duration="1500">

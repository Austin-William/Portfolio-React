                    ...
                    <div className='experiences__body__selects'>
                        ...
                        <div className='experiences__body__selects__buttons' data-aos="fade-up" data-aos-duration="1000">
                            {experiences.map((experience: Record<string, any>, index: number) => (
                                <button key={index} type="button" aria-pressed={index === indexSelectedExperience} className={`experiences__body__selects__buttons__button ${index === indexSelectedExperience ? 'selected' : ''}`} onClick={() => changeSelectedExperience(index)}>
                                    {experience.name}
                                </button>
                            ))}
                        </div>
